...
class Adafruit_TFTLCD_ILI9342 : public Adafruit_GFX {

 public:

  Adafruit_TFTLCD_ILI9342(uint8_t cs, uint8_t cd, uint8_t wr, uint8_t rd, uint8_t rst);
  Adafruit_TFTLCD_ILI9342(void);
